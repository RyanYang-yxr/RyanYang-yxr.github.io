function share_url(webid, url, mytitle, summary){
	...
	var share_services = {
		...
		'more':   "http://www.jiathis.com/send/?webid=" + webid + "&url="+url+"&title="+encodeURIComponent("鍒嗕韩濂芥枃锛氥��"+title+"銆�")+"&summary="+encodeURIComponent(summary)
	};
